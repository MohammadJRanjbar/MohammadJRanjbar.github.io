...
<br />
    ...
    <h2>Publications</h2>
    <ul>
        <li><strong>MJ. Ranjbar</strong>, Mohammad Amini, Parmis Bathayian, H. Faili, A. Shakery. <em>PARSA-Bench: A Comprehensive Persian Audio-Language Model Benchmark.</em> Under preparation for submission to Interspeech 2026.</li>
        ...
        <li><strong>MJ. Ranjbar</strong>, A. Shakery, H. Faili. PersianPunc: A Large-Scale Dataset and BERT-Based Approach for Persian Punctuation Restoration. Accepted at SilkRoadNLP 2026 (EACL 2026 Workshop).</li>
        <li><strong>MJ. Ranjbar</strong>, A.H. Sheikh, S. Ranjbar Kalahroodi, S. Karimi, A. Shakery, H. Faili. <a href="https://arxiv.org/abs/2506.00250" target="_blank">PersianMedQA: Evaluating Large Language Models on a Persian-English Bilingual Medical Question Answering Benchmark</a>. Accepted at LREC 2026.</li>
        <li>S. Jafari, T. Azin, M.H. Khan, <strong>MJ. Ranjbar</strong>, et al. APARSIN: A Multi-Variety Sentiment and Translation Benchmark for Iranic Languages. Accepted at SilkRoadNLP 2026 (EACL 2026 Workshop).</li>
